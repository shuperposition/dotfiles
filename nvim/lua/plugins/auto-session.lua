return {
  {
    ...
    keys = {
      ...
      { "<leader>oo", "<cmd>AutoSession search<CR>", desc = "Session open" },
      { "<leader>os", "<cmd>AutoSession save<CR>", desc = "Save session" },
      { "<leader>oa", "<cmd>AutoSession toggle<CR>", desc = "Toggle autosave" },
    },
    ...
    opts = {
      -- The following   -- Saving / restoring
